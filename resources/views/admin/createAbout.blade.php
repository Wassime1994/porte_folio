    ...
    <div x-data="{ sidebarOpen: false }" class="flex h-screen bg-gray-200">
      ...
      <div class="container mx-auto px-6 py-8">
          <h3 class="text-gray-700 text-3xl font-medium">
              <a href={{route('about.create')}} class="bg-red-200 p-2">ADD ABOUT ME </a>
          </h3>
                              ...
                              <tr>
                                  ...
                                  <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                      <div class="flex items-center">
                                        ...
                                        {{--NOM --}}
                                                    <div class="ml-4">
                                                        <div class="text-sm leading-5 font-medium text-gray-900">{{$item->titre}}
                                                        </div>
                                                     </div>
                                    </td>
                                    {{-- DESRIPTION --}}
                                            ...
                                            <td>
                                                <div class="flex">
                                                    <button class=" mx-3 bg-green-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                                                        <a href={{route('about.show',$item->id)}}>Show</a>
                                                    </button>
